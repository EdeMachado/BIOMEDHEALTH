...
describe('AuthContext', () => {
  ...
  it('autentica usuario e persiste sessao em sessionStorage', async () => {
    render(
      <AuthProvider>
        <AuthHarness />
      </AuthProvider>
  ...
  it('permite troca de organizacao para outro usuario valido', async () => {
    render(
      <AuthProvider>
        <AuthHarness />
      </AuthProvider>
  ...
  it('bloqueia tentativa de acesso cruzado por organizacao e mantem sessao anonima', async () => {
    render(
      <AuthProvider>
        <AuthHarness />
      </AuthProvider>
  ...
  it('logout encerra sessao e limpa armazenamento', async () => {
    render(
      <AuthProvider>
        <AuthHarness />
      </AuthProvider>
    ...
    await waitFor(() => expect(screen.getByTestId('usuario-logado').textContent).toBe('anonimo'));
    await waitFor(() => expect(sessionStorage.getItem('biomed_demo_session')).toBeNull());
  });
});
